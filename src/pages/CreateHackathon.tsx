  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Form submission attempt, current data:", {
      ...
      image:
        ...
        (formData.image?.length > 50 ? "... [truncated]" : ""),
    });
    ...
    if (
      ...
      formData.image.length > 1000000
    ) {
      console.warn(
        "Image data URL is very large:",
        (formData.image.length / 1000000).toFixed(2) + " MB"
      );
      ...
      try {
        ...
        setErrors((prev) => ({
          ...prev,
          image:
            "Image is too large. Please choose a smaller image or reduce its size.",
        }));
        return;
      }
    }
    ...
    try {
      if (isEditMode) {
        ...
        console.log("Creating new hackathon with data:", {
          ...newHackathon,
          image:
            newHackathon.image?.substring(0, 50) +
            (newHackathon.image?.length > 50 ? "... [truncated]" : ""),
        });
      ...
      {submissionComplete ? (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <form
            ...
            className="bg-white p-6 rounded-b-lg shadow-md"
          >
            {errors.submit && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <input
                  ...
                  } focus:ring-indigo-500 focus:border-indigo-500 bg-white text-black`}
            ...
            <div className="col-span-1 md:col-span-2 flex justify-end mt-6">
              ...
              <button
                ...
                className={`px-6 py-3 text-white bg-indigo-600 hover:bg-indigo-700 rounded-md transition shadow-sm ${
