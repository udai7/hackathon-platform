...
const HackathonSchema = new mongoose.Schema({
  ...
  image: { type: String, default: 'https://via.placeholder.com/800x400?text=Hackathon' },
...
export default mongoose.model<Hackathon & mongoose.Document>('Hackathon', HackathonSchema); 