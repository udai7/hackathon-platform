...
export const connectDB = async (): Promise<void> => {
  try {
    ...
    console.log(
      "1. Make sure MongoDB is running on your local system or that your Atlas connection string is correct."
    );
    console.log(
      "2. Check if your connection string is correct in the .env file."
    );
    console.log(
      "3. If using MongoDB Atlas, ensure your IP address is whitelisted."
    );
    console.log(
      "4. Verify that your username/password is correct if using authentication."
    );
    console.log(
