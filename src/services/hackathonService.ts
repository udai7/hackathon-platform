...
export const getHackathonsByCreator = async (creatorId: string): Promise<Hackathon[]> => {
  try {
...
export const createHackathon = async (hackathon: Hackathon): Promise<Hackathon> => {
  try {
...
export const updateHackathon = async (hackathon: Hackathon): Promise<Hackathon | null> => {
  try {
...
export const registerParticipant = async (hackathonId: string, participant: Participant): Promise<any> => {
  try {
    const response = await api.post(`/hackathons/${hackathonId}/participants`, participant);
    return response.data;
  } catch (error) {
...
export const createPaymentOrder = async (hackathonId: string, participantId: string, amount: number): Promise<any> => {
  try {
    const response = await api.post(`/payments/create/${hackathonId}/${participantId}`, { amount });
    return response.data;
  } catch (error: any) {
...
export const verifyPayment = async (paymentId: string, orderId: string, signature: string): Promise<any> => {
  try {
...
export const withdrawParticipant = async (hackathonId: string, participantId: string): Promise<boolean> => {
  try {
    await api.delete(`/hackathons/${hackathonId}/participants/${participantId}`);
    return true;
  } catch (error) {
...
export const submitProject = async (
  ...
  try {
    const response = await api.post(
      `/hackathons/${hackathonId}/participants/${participantId}/submission`,
      submission
    );
    return response.data;
  } catch (error) {
